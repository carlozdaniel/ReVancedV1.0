...
then
    ...
    java -jar revanced-cli.jar -b revanced-patches.jar --mount \
                               -e microg-support \
                               -a com.google.android.apps.youtube.music_armeabi-v7a.apk -o build/revanced-music-root_armeabi-v7a.apk
    echo "Building Non-root APK"
    java -jar revanced-cli.jar -b revanced-patches.jar \
                               -a com.google.android.apps.youtube.music_armeabi-v7a.apk -o build/revanced-music-nonroot_armeabi-v7a.apk
else
